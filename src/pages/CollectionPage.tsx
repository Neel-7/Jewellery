...
const mapSlugToCriteria = (slug: string | undefined) => {
  if (!slug)
    return {
      ...
      filterKey: "all",
      filterType: "all",
      description: "Explore our peerless jewelry curations.",
    };
  ...
  if (s === "rings")
    return {
      ...
      filterType: "category",
      description:
        "Bespoke bands, solitaires, and eternity rings crafted in 18k gold and platinum.",
    };
  if (s === "necklaces")
    return {
      title: "The Necklaces",
      ...
      filterType: "category",
      description:
        "Luminous pendants, chokers, and rivières that capture and refract natural light.",
    };
  if (s === "earrings")
    return {
      title: "The Earrings",
      ...
      filterType: "category",
      description:
        "Elegant hoops, drops, and studs crafted with rare gems and diamonds.",
    };
  if (s === "bracelets")
    return {
      title: "The Bracelets",
      ...
      filterType: "category",
      description:
        "Artistic bangles, cuffs, and tennis bracelets made for fluid modern luxury.",
    };
  ...
  if (s === "high-jewelry")
    return {
      title: "High Jewelry",
      filterKey: "High Jewelry",
      filterType: "collection",
      description:
        "One-of-a-kind wearable masterpieces showcasing the heights of our design and rare gemstones.",
    };
  if (s === "fine-jewelry")
    return {
      title: "Fine Jewelry",
      filterKey: "Fine Jewelry",
      filterType: "collection",
      description:
        "Everyday treasures in 18k yellow, white, and rose gold with brilliant-cut diamonds.",
    };
  if (s === "bridal" || s === "engagement")
    return {
      title: "Engagement & Bridal",
      filterKey: "Engagement & Bridal",
      filterType: "collection",
      description:
        "Handcrafted engagement rings and wedding bands celebrating eternal romance.",
    };
  if (s === "timepieces" || s === "watches")
    return {
      title: "Fine Timepieces",
      filterKey: "Timepieces",
      filterType: "collection",
      description:
        "Swiss-made automatic horology combining mechanical perfection with fine jewelry design.",
    };
  if (s === "labonno" || s === "labonno-collections")
    return {
      title: "Labonno Collections",
      filterKey: "Labonno Collections",
      filterType: "collection",
      description:
        "Signature lines representing our artistic heritage and sculpted craftsmanship.",
    };
  ...
  return {
    ...
    filterType: "all",
    description:
      "Peerless fine jewelry, bridal sets, and timepieces expressing our artistic heritage.",
  };
};
...
export const CollectionPage: React.FC = () => {
  ...
  const { data, isLoading, isFetching } =
    useGetFilteredProductsQuery(finalQueryArgs);

  const isCategoryPage =
    criteria.filterType === "category" || criteria.filterKey === "Timepieces";
      ...
      <div className="container mx-auto px-4 sm:px-8">
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="h-9 px-4 text-[10px] tracking-widest relative"
                >
              ...
              <SheetContent
                side="right"
                className="bg-background text-foreground p-8 overflow-y-auto w-[320px]"
              >
                <SheetHeader className="border-b border-border pb-4 mb-6">
                  <SheetTitle className="text-sm font-sans tracking-widest uppercase">
                    Select Filters
                  </SheetTitle>
                </SheetHeader>
                <ProductFilters
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <main className="lg:col-span-9 flex flex-col justify-between">
            <div
              className={
                isFetching && !isLoading ? "opacity-60 duration-300" : ""
              }
            >
              <ProductGrid
